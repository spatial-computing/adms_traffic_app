...
namespace ServerMonitor
{
    public class ExceptionEmailReporter
    {
        ...
        public void SendEmail()
        {
            ...
            MailAddress from = new MailAddress("StreamInsight323@gmail.com", "StreamInsight Infolab", System.Text.Encoding.UTF8);

            // Set destinations for the e-mail message.
            MailAddress to = new MailAddress("demiryur@usc.edu");
            // Specify the message content.
            MailMessage message = new MailMessage(from, to);
            message.To.Add(new MailAddress("ottiling@usc.edu"));
            ...
            message.Subject = "StreamInsight Server/ Database Monitor Notification";
