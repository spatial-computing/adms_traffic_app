...
namespace ExceptionEmail
{
    public class ExceptionEmailReporter
    {
        ...
        // Command line argument must the the SMTP host.
            ...
            {
                Credentials = new NetworkCredential("si.uscinfolab@gmail.com", "infolab323"),
                EnableSsl = true
            };

            MailAddress from = new MailAddress("beipan@usc.edu", "Penny Pan", System.Text.Encoding.UTF8);

            // Set destinations for the e-mail message.
            MailAddress to = new MailAddress("beipan@usc.edu");
            ...
            message.Subject = "StreamInsight Server Exception Notification";
