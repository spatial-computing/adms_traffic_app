...
{
    public class SocketPointFreewaySensorSpeedOutput : XmlPointFreewaySensorSpeedOutput
    {
        private readonly String ip;
        private readonly int port;

        public SocketPointFreewaySensorSpeedOutput(SocketTrafficOutputConfig configInfo, CepEventType cepEventType)
        ...
        protected override void GenerateOutput()
        {
            ...
            writer.Write(CreateOutputMessage()); //(ba, 0, ba.Length);
