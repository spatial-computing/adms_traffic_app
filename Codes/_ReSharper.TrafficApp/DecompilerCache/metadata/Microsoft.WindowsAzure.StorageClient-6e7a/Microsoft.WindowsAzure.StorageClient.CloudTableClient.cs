...
namespace Microsoft.WindowsAzure.StorageClient
{
    public class CloudTableClient
    {
        ...
        public ResultSegment<string> ListTablesSegmented(string prefix, int maxResults,
        ...
        public IAsyncResult BeginListTablesSegmented(string prefix, int maxResults, ResultContinuation continuationToken,
