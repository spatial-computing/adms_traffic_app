...
namespace XMLParser.CongestionService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="IAI_CongestionServiceSoapBinding", Namespace="http://rtsiai01.riits.net/IAI/services/IAI_CongestionService")]
    public partial class CongestionServiceService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        
        private System.Threading.SendOrPostCallback initializeOperationCompleted;
        
        private System.Threading.SendOrPostCallback getTrafficInfoOperationCompleted;
        ...
        public CongestionServiceService() {
            this.Url = global::XMLParser.Properties.Settings.Default.XMLParser_CongestionService_CongestionServiceService;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="http://external.regional.services.nateng.com", ResponseNamespace="http://rtsiai01.riits.net/IAI/services/IAI_CongestionService")]
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="http://external.regional.services.nateng.com", ResponseNamespace="http://rtsiai01.riits.net/IAI/services/IAI_CongestionService")]
        [return: System.Xml.Serialization.SoapElementAttribute("getTrafficInfoReturn")]
        public string getTrafficInfo(string userName, string userPass, string xmlMessageRequest) {
            object[] results = this.Invoke("getTrafficInfo", new object[] {
                        userName,
                        userPass,
                        xmlMessageRequest});
        ...
        public void getTrafficInfoAsync(string userName, string userPass, string xmlMessageRequest) {
            this.getTrafficInfoAsync(userName, userPass, xmlMessageRequest, null);
        }
        
        /// <remarks/>
        public void getTrafficInfoAsync(string userName, string userPass, string xmlMessageRequest, object userState) {
            if ((this.getTrafficInfoOperationCompleted == null)) {
                this.getTrafficInfoOperationCompleted = new System.Threading.SendOrPostCallback(this.OngetTrafficInfoOperationCompleted);
            }
            this.InvokeAsync("getTrafficInfo", new object[] {
                        userName,
                        userPass,
                        xmlMessageRequest}, this.getTrafficInfoOperationCompleted, userState);
        }
        
        private void OngetTrafficInfoOperationCompleted(object arg) {
            if ((this.getTrafficInfoCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.getTrafficInfoCompleted(this, new getTrafficInfoCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="http://services.nateng.com", ResponseNamespace="http://rtsiai01.riits.net/IAI/services/IAI_CongestionService")]
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class getTrafficInfoCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal getTrafficInfoCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
