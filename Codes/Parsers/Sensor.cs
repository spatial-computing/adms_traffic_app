...
namespace Parsers
{
    public class Sensor 
    {
         public Sensor(string agency, string id, double latitude, double longitude, String OST, int direction, String FST)
        {
            ID = id;
        ...
        public bool AllFieldsEqual(Sensor second)
        {
            ...
            result = ID == second.ID && Direction == second.Direction && //OnStreet == second.OnStreet && FromStreet == second.FromStreet && ToStreet == second.ToStreet && 
                (bool)(GeogLocation.Lat == second.GeogLocation.Lat) && (bool)(GeogLocation.Long == second.GeogLocation.Long) && Agency == second.Agency;
